...
<nav>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="#"><i class="fas fa-user"></i>TEST</a></li>
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" style="height:280px" name="sinopsis" placeholder="Description"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>gambar:</strong>
                <input type="text" name="gambar" class="form-control" placeholder="Title">
            </div>
        </div>
